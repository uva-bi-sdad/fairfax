...
# join Fairfax housing data by building from the open data portal as of 6/8/20
...
setwd("~/git/fairfax/src/")

housing_units <- readOGR(dsn="ffx-housing/2020/Current_Housing_Units/",layer="4879a26f-bc9a-498f-b252-bb1cb51cf9f32020330-1-1u606jq.7gy7j")
...
tax_parcel <- fread("ffx-housing/2020/Tax_Administration_s_Real_Estate_-__Parcels_Data.csv")
tax_assessment <- fread("ffx-housing/2020/Tax_Administration_s_Real_Estate_-_Assessed_Values.csv")
tax_dwelling <- fread("ffx-housing/2020/Tax_Administration_s_Real_Estate_-_Dwelling_Data.csv")
tax_land <- read.csv("ffx-housing/2020/Tax_Administration_s_Real_Estate_-_Land_Data.csv")
...
fwrite(ffx_housing4, file="ffx-housing/fairfax_housing_2020.csv")
