...
The next step is to go through each table and find which tables contain Fairfax data. Right now, it seems like that will require filtering by the fips_code or zip code. 
