...
wac09_ffx_tract <- wac09_ffx %>% arrange(trct) %>%
                                 group_by(trct) %>% mutate(job09_all = sum(C000, na.rm = TRUE),
                                                           ...
                                                           job09_earn12513333 = sum(CE02, na.rm = TRUE)/job09_all,
                                                           job09_earn3334ovr = sum(CE03, na.rm = TRUE)/job09_all,
...
wac17_ffx_tract <- wac17_ffx %>% arrange(trct) %>%
                                 group_by(trct) %>% mutate(job17_all = sum(C000, na.rm = TRUE),
                                                           ...
                                                           job17_earn12513333 = sum(CE02, na.rm = TRUE)/job17_all,
                                                           job17_earn3334ovr = sum(CE03, na.rm = TRUE)/job17_all,
